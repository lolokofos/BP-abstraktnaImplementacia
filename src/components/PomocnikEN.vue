  ...
  <v-dialog  style="max-width: 80%; max-height: 90%;">
      <v-card :class="{'backgroundGuessBLack' : darkMode}">
        <v-card-title>
          <v-row>
            <v-col cols="12" md="4">
              <v-btn block @click="content = 'content1'" :class="{'button-light': !darkMode, 'button-dark': darkMode}">General</v-btn>
            </v-col>
            <v-col cols="12" md="4">
              <v-btn block @click="content = 'content2'" :class="{'button-light': !darkMode, 'button-dark': darkMode}">Abstract <br v-if="screenWidth <= 400"> implementation</v-btn>
            </v-col>
            <v-col cols="12" md="4">
              <v-btn block @click="content = 'content3'" :class="{'button-light': !darkMode, 'button-dark': darkMode}">Grammar</v-btn>
            </v-col>
          </v-row>
        </v-card-title>
        ...
        <div v-if="content === 'content1'" class="text-left">
          <v-row>
            <v-col cols="12" md="5" class="test">
              <v-btn variant="elevated" class="spustit" :class="{'button-light-spustit': !darkMode, 'button-dark-spustit': darkMode}">Visualize <v-icon>mdi-play</v-icon></v-btn>
            </v-col>
          ...
          <v-row>
            <v-col cols="12" md="5">
              <v-row>
                ...
                <v-col class="formular" cols="12">
                  <v-btn :class="{'buttonPremenne-light': !darkMode, 'button-dark-spustit': darkMode}" disabled>Set variable</v-btn>
                </v-col>
              </v-row>
            </v-col>
          ...
          <v-row>
            <v-col cols="12" md="5" class="test">
              <v-btn variant="elevated" :class="{'button-light': !darkMode, 'button-dark': darkMode}">Paste Example</v-btn>
            </v-col>
          ...
          <v-row>
            <v-col cols="12" md="5" class="test">
              <v-btn variant="elevated" :class="{'button-light': !darkMode, 'button-dark': darkMode}">Upload Program<v-icon :color="darkMode ? '#D500F9' : 'info'">mdi-upload</v-icon></v-btn>
            </v-col>
            <v-col cols="12" md="7" class="justify-center">
          ...
          <v-row>
            <v-col cols="12" md="5" class="test">
              <v-btn :class="{'button-light-spustit': !darkMode, 'button-dark-spustit': darkMode}">Code Translation
          ...
          <v-row>
            <v-col cols="12" md="5" class="test">
              <v-row style="margin: 0;">
                <v-btn variant="elevated"  style="margin-right: 10px;" :class="{'button-light': !darkMode, 'button-dark': darkMode}">Whole sequence</v-btn>
                <v-btn variant="elevated" :style="screenWidth <= 416? 'margin-top:10px;' : 'margin-top:0px;'" :class="{'button-light': !darkMode, 'button-dark': darkMode}">Step by step</v-btn>
              </v-row>
            </v-col>
            <v-col cols="12" md="7" class="justify-center">
          ...
          <v-row>
            <v-col cols="12" md="5" class="test">
              <v-row style="margin: 0;">
                <v-btn variant="tonal" style="margin-right: 10px;"><v-icon :color="darkMode ? '#D500F9' : 'info'">mdi-chevron-left</v-icon>Previous</v-btn>
                <v-btn variant="tonal">Next <v-icon :color="darkMode ? '#D500F9' : 'info'">mdi-chevron-right</v-icon></v-btn>
              </v-row>
            </v-col>
            <v-col cols="12" md="7" class="justify-center">
          ...
          <v-row >
            <v-col cols="12" md="5" class="test">
              <v-btn variant="elevated" style="padding: 5px;" :style="screenWidth <= 450 ? 'padding: 10px 50px 40px 50px;' : 'padding: 5px;'" :class="{'button-light': !darkMode, 'button-dark': darkMode}">Guess next <br v-if="screenWidth <= 450"> configuration</v-btn>
            </v-col>
            <v-col cols="12" md="7" class="justify-center">
